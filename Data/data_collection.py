"""
Goal : 
    The goal of this code is to download a set of images from the Unsplash API and web scrapping based on a given search query, 
    and then save the downloaded images to a local directory. The code also saves the metadata of the downloaded images to a JSON file.
...
if __name__ == "__main__":
    keyword = "face"
    num_pages = 100  # Number of pages you want to fetch
